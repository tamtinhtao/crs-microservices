...
public class CourseClient {
    ...
    @Value("${course-service.base-url:http://127.0.0.1:8082}")
    ...
    public void releaseSeat(Long courseId) {
        ...
        try {
            ...
            e.printStackTrace(); // <--- Thêm dòng này để in lỗi thật ra console
            throw new IllegalStateException("Khong the ket noi toi course-service: " + e.getMessage());
        }
    }
}